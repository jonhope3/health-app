...
import com.hopehealth.app.data.db.DateCaloriesRow
import com.hopehealth.app.data.db.DiaryItemDao
import com.hopehealth.app.data.db.FoodItemDao
import com.hopehealth.app.data.db.FoodItemEntity
import com.hopehealth.app.data.db.toDomain
import com.hopehealth.app.data.db.toEntity
...
private fun toDomain(entity: com.hopehealth.app.data.db.DiaryItemEntity): DiaryItem =
    entity.toDomain()

private fun toDomain(entity: com.hopehealth.app.data.db.FoodItemEntity): FoodItem =
    entity.toDomain()
