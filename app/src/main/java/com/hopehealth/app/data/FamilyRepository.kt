 ...
 * Business logic for *predictions* lives in [com.hopehealth.app.services.CyclePredictionEngine].
 */
@Singleton
class FamilyRepository @Inject constructor(
    ...
    suspend fun deleteLogForDate(date: LocalDate) = logDao.deleteForDate(date.toString())

    suspend fun deleteCycleById(id: Long) = cycleDao.deleteById(id)
